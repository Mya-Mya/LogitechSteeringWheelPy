...
class G29:
    ...
    def __init__(
        ...
        self.operating_range = operating_range_deg

        self.operating_range_rad = radians(operating_range_deg)
        self.sgn_angle = {
            "counterclockwise": -1,
            "clockwise": +1
        }[positive_angle]
    ...
    def update(self):
        ...
        self.steering_rad = self.sgn_angle * self.state.lX / 65536 * self.operating_range_rad
